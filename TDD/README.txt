...
Os testes se encotram no diretorio tests. Utilizamos o Pytest para nos auxiliar.

Por fim, criamos 2 relatórios sobre os testes: 
    1- report.xml
    2- index.html, que se encontra no diretorio covera_relatorio_html e pode ser visto usando qualquer navegador.
